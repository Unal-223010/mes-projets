...
#!/bin/bash
x=1 # we create a counter for while loop. Bunun sayesinde infini loop's olmayacak.

while [[ $x -le 10 ]]  # -le means ,  x less than or equal 100. x 10'a esit olunca do-done arasindaki kod'un calismasi bitecektir.
do
